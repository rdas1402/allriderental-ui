  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.4)), url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')`
        }}
      ></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-12 border border-blue-200 shadow-lg mb-16">
          <h2 className="text-3xl font-semibold text-slate-800 mb-8 text-center">Why Build Your Career With Us?</h2>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-8 border border-blue-200 shadow-lg">
          <h2 className="text-2xl font-semibold text-slate-800 mb-8">Current Opportunities</h2>
              ...
              <div key={job.id} className="bg-white rounded-xl p-6 border border-blue-200 hover:border-gold-400 transition-all duration-300 group shadow-sm">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-slate-800 mb-2 group-hover:text-gold-500 transition-colors">
                      {job.title}
                    </h3>
                  ...
                  <div className="mt-4 lg:mt-0 lg:ml-6">
                    <button className="bg-gold-500 hover:bg-gold-600 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg w-full lg:w-auto">
                      Apply Now
                    </button>
                  </div>
                </div>
